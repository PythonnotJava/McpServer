"""MIQPSolver - 混合整数二次规划求解器"""

import gurobipy as gp
from .base import BaseSolver


class MIQPSolver(BaseSolver):
    ...
    def solve(
        ...
        with gp.Env() as env, gp.Model(env=env, name="miqp") as m:
            extra = {"MIPFocus": mip_focus}
            if non_convex:
                extra["NonConvex"] = 2
            self._apply_params(m, **extra)

            var_names = self._collect_var_names(linear_objective, variable_types, constraints)
